...
import { erc20MetadataAbi } from "@/common/abis/erc20-metadata";
...
function useContractRead(arg0: { abi: import("starknet").Abi; functionName: string; address: string; args: never[]; }): { data: any; } {
